...
const Home = () => {
  ...
  return (
   ...
   <div className='conrtainer'>
     ...
     <img src="https://www.investsmall.co/wp-content/uploads/2021/09/POS-agencies-in-Nigeria.jpg"  class="card-img-top shadow-md" id='homelargeimage' alt="..." />
      <div class="card-body" >
  ...
  <div class="row ">
    <div class="col-md-6" data-aos="fade-right" data-aos-duration="1000">
      <img src="https://fitsmallbusiness.com/wp-content/uploads/2022/08/FeatureImage_Types_of_POS_Systems.jpg" class=" homecard img-fluid rounded shadow-sm"  alt="..."/>
    </div>
    <div class="col-md-6 ">
...
<div class="card mb-3 mt-5" style={{maxwidth:540}}>
  <div class="row ">
    ...
    <div class="col-md-6  " data-aos="fade-up" data-aos-duration="1000"  >
      <img src="https://img.freepik.com/premium-photo/human-hand-working-with-3d-rendering-cashier-machine_493806-1446.jpg?w=2000"  class=" homecard img-fluid rounded shadow-sm"  alt="..."/>
    </div>
...
<h1 className='nhelp mt-5 fw-bold'>Need help?</h1>
<h4 className='mt-2'><span className='contact-number'>+63 9295-714-379</span> Answer desk is ready</h4>
